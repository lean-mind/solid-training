...
```typescript diff title="Responsabilidades separadas"
  class Person {
    readonly name: string
...
## OCP Code Smells
  ...
  - Clase que estamos constantemente modificando
...
## Liskov Substitution Principle (LSP)
  ...
  - Todos los hijos deberían poder ser utilizado como sus padres.
...
<Notes>
  ...
  - En TS no podemos hacer override
